package com.reimbursement.approval_service.adapters.inbound.controllers;
...
public class ApprovalController {
    ...
    public ResponseEntity<Object> listApprovals(ApprovalSpecification spec,
        ...
        Page<Approval> approvals = approvalService.listApprovals(spec, page);
    ...
    public ResponseEntity<Object> createApproval(
        ...
        Approval approval = approvalService.saveApproval(approvalDto);
    ...
    public ResponseEntity<?> updateApproval(
        ...
        ApprovalStatus status = approvalDto.getStatus();
        Approval updatedApproval = approvalService.saveApproval(status, approval_id);
